...
Hyweb.BlocksGroup['Bootstrap 4 Snippets'] =
...
Hyweb.Blocks.add("bootstrap4/signin-split", {
  name: "Modern Sign In Page with Split Screen Format",
  dragHtml: '<img src="' + Hyweb.baseUrl + 'icons/product.png">',
...
Hyweb.Blocks.add("bootstrap4/image-gallery", {
  name: "Image gallery",
...
Hyweb.Blocks.add("bootstrap4/slider-header", {
...
Hyweb.Blocks.add("bootstrap4/video-header", {
  name: "Video Header",
  dragHtml: '<img src="' + Hyweb.baseUrl + 'icons/image.svg">',
...
Hyweb.Blocks.add("bootstrap4/about-team", {
...
Hyweb.Blocks.add("bootstrap4/portfolio-one-column", {
...
Hyweb.Blocks.add("bootstrap4/portfolio-two-column", {
...
Hyweb.Blocks.add("bootstrap4/portfolio-three-column", {
...
Hyweb.Blocks.add("bootstrap4/portfolio-four-column", {
