...
Hyweb.ComponentsGroup["Bootstrap 4"] = [
  "html/container",
  "html/gridrow",
  "html/button",
  "html/buttongroup",
  ...
  properties: [
    {
      ...
      sort: base_sort++,
      section: style_section,
      data: { header: "边界圆角", expanded: false }
    },
    {
      name: "上左",
...
// ! 左侧模块选择
Hyweb.Components.extend("_base", "html/container", {
...
Hyweb.Components.extend("_base", "html/heading", {
...
Hyweb.Components.extend("_base", "html/link", {
  nodes: ["a"],
  name: "Link",
...
Hyweb.Components.extend("_base", "html/image", {
  nodes: ["img"],
  name: "图片",
  html:
    '<img src="' + Hyweb.baseUrl + 'icons/image.svg" height="128" width="128">',
...
Hyweb.Components.extend("_base", "html/label", {
  name: "Label",
  nodes: ["label"],
...
Hyweb.Components.extend("_base", "html/button", {
...
Hyweb.Components.extend("_base", "html/buttongroup", {
  classes: ["btn-group"],
  name: "按钮组",
...
Hyweb.Components.extend("_base", "html/buttontoolbar", {
  classes: ["btn-toolbar"],
  name: "Button Toolbar",
...
Hyweb.Components.extend("_base", "html/alert", {
  classes: ["alert"],
  name: "Alert",
...
Hyweb.Components.extend("_base", "html/badge", {
  classes: ["badge"],
...
Hyweb.Components.extend("_base", "html/card", {
  classes: ["card"],
...
Hyweb.Components.extend("_base", "html/listgroup", {
  name: "List Group",
...
Hyweb.Components.extend("_base", "html/listitem", {
  name: "List Item",
...
Hyweb.Components.extend("_base", "html/breadcrumbs", {
  classes: ["breadcrumb"],
  name: "Breadcrumbs",
...
Hyweb.Components.extend("_base", "html/breadcrumbitem", {
...
Hyweb.Components.extend("_base", "html/pagination", {
  classes: ["pagination"],
  name: "Pagination",
...
Hyweb.Components.extend("_base", "html/pageitem", {
  classes: ["page-item"],
...
Hyweb.Components.extend("_base", "html/progress", {
  classes: ["progress"],
  name: "Progress Bar",
...
Hyweb.Components.extend("_base", "html/jumbotron", {
  classes: ["jumbotron"],
...
Hyweb.Components.extend("_base", "html/navbar", {
  classes: ["navbar"],
...
Hyweb.Components.extend("_base", "html/form", {
  nodes: ["form"],
  image: "icons/form.svg",
  name: "Form",
  html:
    '<form><div class="form-group"><label>Text</label><input type="text" class="form-control"></div></div></form>',
  properties: [
    {
      name: "Style",
      key: "style",
...
Hyweb.Components.extend("_base", "html/textinput", {
  name: "Text Input",
  attributes: { type: "text" },
  image: "icons/text_input.svg",
  html:
    '<div class="form-group"><label>Text</label><input type="text" class="form-control"></div></div>',
  properties: [
    {
      name: "Value",
      key: "value",
...
Hyweb.Components.extend("_base", "html/selectinput", {
  nodes: ["select"],
  name: "Select Input",
  image: "icons/select_input.svg",
  html:
    '<div class="form-group"><label>Choose an option </label><select class="form-control"><option value="value1">Text 1</option><option value="value2">Text 2</option><option value="value3">Text 3</option></select></div>',
        ...
        properties.push({
          ...
          onChange: function(node, value, input) {
            ...
            if (input.nodeName == "BUTTON") {
              option.remove();
              Hyweb.Components.render("html/selectinput");
              return node;
            }
...
Hyweb.Components.extend("_base", "html/textareainput", {
  name: "Text Area",
...
Hyweb.Components.extend("_base", "html/radiobutton", {
  name: "Radio Button",
...
Hyweb.Components.extend("_base", "html/checkbox", {
  name: "Checkbox",
...
Hyweb.Components.extend("_base", "html/fileinput", {
  name: "Input group",
...
Hyweb.Components.extend("_base", "html/table", {
  nodes: ["table"],
  classes: ["table"],
...
Hyweb.Components.extend("_base", "html/tablerow", {
  nodes: ["tr"],
  name: "Table Row",
...
Hyweb.Components.extend("_base", "html/tablecell", {
  nodes: ["td"],
  name: "Table Cell",
  html: "<td>Cell</td>"
});

Hyweb.Components.extend("_base", "html/tableheadercell", {
  nodes: ["th"],
  name: "Table Header Cell",
  html: "<th>Head</th>"
});

Hyweb.Components.extend("_base", "html/tablehead", {
  nodes: ["thead"],
  name: "Table Head",
...
Hyweb.Components.extend("_base", "html/tablebody", {
  nodes: ["tbody"],
  name: "Table Body",
  html: "<tbody><tr><td>Cell 1</td><td>Cell 2</td><td>Cell 3</td></tr></tbody>"
});

Hyweb.Components.add("html/gridcolumn", {
  name: "Grid Column",
...
Hyweb.Components.add("html/gridrow", {
  name: "Grid Row",
  image: "icons/grid_row.svg",
  classes: ["row"],
  html:
      ...
      .each(function() {
        ...
        properties.push({
          ...
          onChange: function(node, value, input) {
            ...
            if (input.nodeName == "BUTTON") {
              column.remove();
              Hyweb.Components.render("html/gridrow");
              return node;
            }
...
Hyweb.Components.extend("_base", "html/paragraph", {
  nodes: ["p"],
  name: "段落",
...
Hyweb.Components.extend("_base", "html/video", {
  nodes: ["video"],
  name: "视频",
  html:
    '<video width="320" height="240" playsinline loop autoplay><source src="https://storage.googleapis.com/coverr-main/mp4/Mt_Baker.mp4"><video>',
  dragHtml:
